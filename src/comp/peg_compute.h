...
public:
	...
	long startCompute(ComputationSet &compset,Grammar *grammar,std::map<int, EdgesToDelete*>& m);
	...
	void postProcessOneIteration(ComputationSet &compset, std::map<int, EdgesToDelete*>& m);
